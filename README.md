This Python package was used to investigate the performance of the standard Echo State Network(ESN) model for image segmentation based on the features created by
